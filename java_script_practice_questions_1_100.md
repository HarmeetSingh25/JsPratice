...
17. Create three variables of type `string`, `number`, and `boolean`, and log their values.
...
84. Create a program to log the following pattern:
...
- Practice **10 questions per day**
- Write solutions in a separate `.js` file
- Add comments for clarity
- Revisit mixed questions weekly

🔥 If you want, I can also:
- Add **solutions**
- Convert this into a **Notion / PDF / GitHub repo**
- Create a **30‑day JS challenge plan**
